...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_isPlainObject__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_flatten__ = __webpack_require__(133);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_lodash_debounce__ = __webpack_require__(136);
  ...
  return function (_Base) {
    ...
    function _class(options) {
      ...
      if (_this.eventsDebug) {
        ...
        _this.eventsLog = __WEBPACK_IMPORTED_MODULE_3_lodash_debounce___default()(_this.eventsLog, 20);
      }
    ...
    _createClass(_class, [{
      ...
      value: function listeningArguments(selector, eventRule, _handle) {
        ...
        if (__WEBPACK_IMPORTED_MODULE_1_lodash_isPlainObject___default()(selector)) {
          eventRule = selector;
          selector = '';
        }

        if (__WEBPACK_IMPORTED_MODULE_0_lodash_isFunction___default()(eventRule)) {
          _handle = eventRule;
          eventRule = selector;
          selector = '';
        }

        if (__WEBPACK_IMPORTED_MODULE_1_lodash_isPlainObject___default()(eventRule)) {
          return __WEBPACK_IMPORTED_MODULE_2_lodash_flatten___default()(Object.keys(eventRule).map(function (key) {
            var value = eventRule[key];
            return __WEBPACK_IMPORTED_MODULE_1_lodash_isPlainObject___default()(value) ? _this2.listeningArguments(selector ? selector + ' ' + key : key, value) : _this2.listeningArguments(selector, key, value);
          }));
        }

        if (!__WEBPACK_IMPORTED_MODULE_0_lodash_isFunction___default()(_handle)) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__lib_jqueryAdditions__ = __webpack_require__(130);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_base__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mixins_events__ = __webpack_require__(47);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__mixins_content__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__mixins_navigation__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__mixins_views__ = __webpack_require__(140);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(24), __webpack_require__(128)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_filter__ = __webpack_require__(52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_find__ = __webpack_require__(141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_lodash_without__ = __webpack_require__(146);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__view__ = __webpack_require__(161);
  ...
  return function (_Base) {
    ...
    function _class2(options) {
      ...
      Object.defineProperty(_this, 'View', {
        enumerable: true,
        writable: true,
        value: __WEBPACK_IMPORTED_MODULE_3__view__["a" /* default */]
      });
    ...
    _createClass(_class2, [{
      ...
      value: function unbindView($element, viewClass) {
        ...
        if (view) {
          view.terminate();
          this.viewInstances = __WEBPACK_IMPORTED_MODULE_2_lodash_without___default()(this.viewInstances, view);
        }
      }
    }, {
      ...
      value: function getViewsOnElement($element) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_lodash_filter___default()(this.viewInstances, filterOptions);
      }
    }, {
      ...
      value: function getViewsInContainer($container) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_lodash_filter___default()(this.viewInstances, function (view) {
      ...
      value: function getAllViews(viewClass) {
        return __WEBPACK_IMPORTED_MODULE_0_lodash_filter___default()(this.viewInstances, { constructor: viewClass });
      }
    }, {
      key: 'getFirstView',
      value: function getFirstView(viewClass) {
        return __WEBPACK_IMPORTED_MODULE_1_lodash_find___default()(this.viewInstances, { constructor: viewClass });
      }
    }, {
      key: 'getFirstChildView',
      value: function getFirstChildView(viewClass) {
        return __WEBPACK_IMPORTED_MODULE_1_lodash_find___default()(this.viewInstances, function (view) {
...
var toFinite = __webpack_require__(145);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_lodash_mapValues__ = __webpack_require__(162);
...
var _class = function (_normasEvents) {
  ...
  _createClass(_class, [{
    ...
    value: function linkEvents(events) {
      ...
      return __WEBPACK_IMPORTED_MODULE_0_lodash_mapValues___default()(events, function (handle) {
        return typeof handle === 'string' ? _this3[handle].bind(_this3) : (typeof handle === 'undefined' ? 'undefined' : _typeof(handle)) === 'object' ? _this3.linkEvents(handle) : handle;
      });
    }
  }]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__index__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__mixins_turbolinks__ = __webpack_require__(165);



/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_1__mixins_turbolinks__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_0__index__["default"]));
    ...
    _createClass(_class, [{
      ...
      value: function visit(location) {
        if (this.turbolinksEnabled) {
          ...
          _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'visit', this).call(this, location);
        }
      }
    }, {
      key: 'setHash',
      value: function setHash(hash) {
        if (this.turbolinksEnabled) {
          ...
          _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'setHash', this).call(this, hash);
        }
      }
    }, {
      key: 'replaceLocation',
      value: function replaceLocation(url) {
        if (this.turbolinksEnabled) {
          ...
          _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'replaceLocation', this).call(this, url);
        }
      }
    }, {
      key: 'pushLocation',
      value: function pushLocation(url) {
        if (this.turbolinksEnabled) {
          ...
          _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'pushLocation', this).call(this, url);
        }
      }
    }, {
      key: 'sayAboutPageLoading',
      value: function sayAboutPageLoading(state) {
        if (this.turbolinksEnabled) {
          ...
          _get(_class.prototype.__proto__ || Object.getPrototypeOf(_class.prototype), 'sayAboutPageLoading', this).call(this, state);
        }
      }
    }]);
...
function patchTurbolinksPreviewControl(Turbolinks) {
  var OurView = function (_Turbolinks$View) {
    _inherits(OurView, _Turbolinks$View);

    function OurView() {
      _classCallCheck(this, OurView);

      return _possibleConstructorReturn(this, (OurView.__proto__ || Object.getPrototypeOf(OurView)).apply(this, arguments));
    }

    _createClass(OurView, [{
      key: 'render',
  ...
  var OurSnapshotRenderer = function (_Turbolinks$SnapshotR) {
    _inherits(OurSnapshotRenderer, _Turbolinks$SnapshotR);

    // added `isPreview` argument
    function OurSnapshotRenderer(currentSnapshot, newSnapshot, isPreview) {
      _classCallCheck(this, OurSnapshotRenderer);

      var _this3 = _possibleConstructorReturn(this, (OurSnapshotRenderer.__proto__ || Object.getPrototypeOf(OurSnapshotRenderer)).call(this, currentSnapshot, newSnapshot));
...
function patchTurbolinks(Turbolinks) {
  var OurHeadDetails = function (_Turbolinks$HeadDetai) {
    _inherits(OurHeadDetails, _Turbolinks$HeadDetai);

    function OurHeadDetails() {
      var _ref2;

      _classCallCheck(this, OurHeadDetails);

      for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
        args[_key] = arguments[_key];
      }

      var _this4 = _possibleConstructorReturn(this, (_ref2 = OurHeadDetails.__proto__ || Object.getPrototypeOf(OurHeadDetails)).call.apply(_ref2, [this].concat(args)));

      _this4.elements = {};
      $(_this4.element).children().each(function (index, element) {
        var key = turboElementToKey(element);
        if (!_this4.elements[key]) {
          _this4.elements[key] = {
        ...
        _this4.elements[key].elements.push(element);
      });
      return _this4;
    }
    ...
    return OurHeadDetails;
  }(Turbolinks.HeadDetails);
